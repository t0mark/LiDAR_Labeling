...
extern const float ang_res_x = 360.0 / float(Horizon_SCAN); // 약 0.3515도
extern const float ang_res_y = 33.2 / float(N_SCAN - 1);    // 약 1.07도
extern const float ang_bottom = 16.6 + 0.1;                 // 하향 각도 중심
extern const int groundScanInd = 15;  // 또는 실험적으로 14~17 사이에서 조정
